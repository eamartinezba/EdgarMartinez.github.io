    ...
    mb.mixin({
        ...
        fgSegHtml: function(a, b) {
            var c, d, e = this.view,
                ...
                if(f.dateS>=f.dateOp ){
                	qIcon='<i class="icon-trash"></i> ';
                	qAction='onclick="deleteSchedule(\''+f.id+'\',\''+f.dateS+'\')"';
                	//console.log(f.dateOp);
                }
            return	j.unshift("fc-day-grid-event", "fc-h-event"), a.isStart && (c = this.getEventTimeText(f), c && (l = '<span class="fc-time">' + Y(c) + "</span>")), d = '<span class="fc-title">'+qIcon + (Y(f.title || "") || "&nbsp;") + "</span>", '<a '+qAction+' class="' + j.join(" ") + '"' + (f.url ? ' href="' + Y(f.url) + '"' : "") + (k ? ' style="' + k + '"' : "") + '><div class="fc-content">' + (this.isRTL ? d + " " + l : l + " " + d) + "</div>" + (h ? '<div class="fc-resizer fc-start-resizer" />' : "") + (i ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
              //  console.log(j);
