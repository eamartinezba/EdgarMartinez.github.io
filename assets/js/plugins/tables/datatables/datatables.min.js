...
(function(h) {
  ...
  function Fa(a) {
    var b = m.defaults.oLanguage,
      c = a.sZeroRecords;
    !a.sEmptyTable && (c && "Sin Datos en la tabla" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
  ...
  function Ja(a, b, c, d) {
    ...
    if (null === e.nTr) {
      ...
      Na(a, e);
      l = 0;
      for (q = (a.aoColumns.length-1); l < q; l++) {
        n = a.aoColumns[l];

        i = c ? d[l] : I.createElement(n.sCellType);
        if(i){ // Comentado tira undefined
       // console.log(l);
          i._DT_CellIndex = {
            row: b,
            column: l
  ...
  function L(a, b, c, d) {
    ...
    else if (b = m.ext, b = b.sErrMode || b.errMode, a && u(a, null, "error", [a, d, c]), "alert" == b) console.log(c);
    else {
  ...
  m.defaults = {
    ...
    oLanguage: {
      oAria: {
        ...
        sSortDescending: ": Ordenar de formaa descendente"
      },
      oPaginate: {
        sFirst: "Primero",
        sLast: "Ultimo",
      ...
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "No resultados encontrados"
    },
